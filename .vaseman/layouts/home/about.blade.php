                ...
                <div class="col-md-6 col-sm-6">
                    <div class="about-box wow animated fadeInDown" data-wow-delay="0.6s">
                        ...
                        <div class="about-box-text">
                            <h4>彈性方案</h4>
                            <p>
                                星辰設計提供多種網頁設計方案，可以根據您的事業規模大小來做選擇。同時也可以根據需求來任選加購的功能，
                                無論是報名系統、徵才頁面等等都能自由加裝，讓網頁設計充滿彈性。
                            </p>
                        </div>
                    </div><!--about us box end-->
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="about-box wow animated fadeInDown" data-wow-delay="0.8s">
                        ...
                        <div class="about-box-text">
                            <h4>高速製作</h4>
                            <p>
                                對新創企業來講，時間就是金錢。星辰設計的網頁設計方案可以大幅降低製作過程的溝通時間，
                                迅速替客戶完成網頁設計，讓您的事業更快啟動，不受拖延。
                            </p>
                        </div>
                    </div><!--about us box end-->
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="about-more-info wow animated fadeInUp" data-wow-delay="0.3s">
                            <p>
                                星辰設計提供了與一般網頁設計公司不同的網站服務模式，您不需要付出昂貴的價格與長時間的等待，
                                只要挑選合適的網站方案與想要的功能，我們可以快速替您設計出理想的網站，不讓事業的啟動受到拖延。
                            </p>
                            <p>
                                如果您需要的不只是網頁設計，還需要進行內部管理，或特殊服務，星辰設計也能夠替您進行客製化雲端系統開發。
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
